namespace AndroidCompound5.DTOs
{
    ...
    {
        public string DolphinId { get; set; }//;//[3] ;		// Dolphin ID number
        ...
        public string StartCmp { get; set; }//;//[13] ;		// Start Compound number//exclude
        public string StartSita { get; set; }//;//[10] ;		// Start Sita number
        ...
        public string EnforcerId { get; set; }//;//[6] ;		// Enforcer ID		//exclude
        public string CurrMukim { get; set; }//;//[2] ;		// Enforcer ID		//exclude
