...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Lifecycle.LiveData 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Lifecycle.LiveData 
for Maven artifact:

artifact=androidx.lifecycle:lifecycle-livedata 

artifact_versioned=androidx.lifecycle:lifecycle-livedata:2.7.0

nuget=lifecycle-livedata.2.7.0
