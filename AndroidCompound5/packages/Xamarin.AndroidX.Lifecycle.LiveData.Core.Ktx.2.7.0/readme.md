...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Lifecycle.LiveData.Core.Ktx 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Lifecycle.LiveData.Core.Ktx 
for Maven artifact:

artifact=androidx.lifecycle:lifecycle-livedata-core-ktx 

artifact_versioned=androidx.lifecycle:lifecycle-livedata-core-ktx:2.7.0

nuget=lifecycle-livedata-core-ktx.2.7.0
