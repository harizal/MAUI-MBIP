...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Lifecycle.LiveData.Core 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Lifecycle.LiveData.Core 
for Maven artifact:

artifact=androidx.lifecycle:lifecycle-livedata-core 

artifact_versioned=androidx.lifecycle:lifecycle-livedata-core:2.7.0

nuget=lifecycle-livedata-core.2.7.0
